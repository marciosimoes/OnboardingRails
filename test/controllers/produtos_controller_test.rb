...
class ProdutosControllerTest < ActionController::TestCase
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post :create, produto: { Descricao: @produto.Descricao, Nome: @produto.Nome, Preco: @produto.Preco, Quantidade: @produto.Quantidade, SKU: @produto.SKU }
    end
  ...
  test "should update produto" do
    patch :update, id: @produto, produto: { Descricao: @produto.Descricao, Nome: @produto.Nome, Preco: @produto.Preco, Quantidade: @produto.Quantidade, SKU: @produto.SKU }
    assert_redirected_to produto_path(assigns(:produto))
  end
